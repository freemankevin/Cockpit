  ...
  return (
    <>
      ...
      <div className="fixed right-auto top-auto mt-1.5 w-36
        ...
        >
          <i className="fa-solid fa-pencil w-3.5 h-3.5 text-gray-500"></i>
          Edit
        </button>
        <button
          ...
          className="w-full px-3 py-1.5 text-left text-xs text-gray-700
                   hover:bg-gray-50/80 flex items-center gap-2.5 transition-colors"
        >
          <i className="fa-solid fa-copy w-3.5 h-3.5 text-gray-500"></i>
          Copy
        </button>
        <button
          ...
          className="w-full px-3 py-1.5 text-left text-xs text-gray-700
                   hover:bg-gray-50/80 flex items-center gap-2.5 transition-colors"
        >
          <i className="fa-solid fa-plug w-3.5 h-3.5 text-gray-500"></i>
          Test Connection
        </button>
        ...
        >
          <i className="fa-solid fa-trash w-3.5 h-3.5"></i>
          Delete
        </button>
      </div>
    </>
