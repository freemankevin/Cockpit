...
const createTerminalConfig = () => ({
  ...
  theme: {
    ...
    black: '#000000', red: '#ff3b30', green: '#28c840', yellow: '#ffcc00',
    blue: '#007aff', magenta: '#af52de', cyan: '#32ade6', white: '#ffffff',
    brightBlack: '#666666', brightRed: '#ff6961', brightGreen: '#5de67a',
    brightYellow: '#ffd60a', brightBlue: '#4da3ff', brightMagenta: '#c779e8',
    brightCyan: '#5ac8f5', brightWhite: '#ffffff',
  },
  scrollback: 5000,
